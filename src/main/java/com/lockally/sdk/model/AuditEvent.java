...
public class AuditEvent {
  ...
  public AuditEvent email(@jakarta.annotation.Nullable String email) {
    this.email = email;
    return this;
  }
  ...
  public AuditEvent eventType(@jakarta.annotation.Nullable String eventType) {
  ...
  public AuditEvent detail(@jakarta.annotation.Nullable String detail) {
    this.detail = detail;
    return this;
  }
  ...
  public AuditEvent ip(@jakarta.annotation.Nullable String ip) {
    this.ip = ip;
    return this;
  }
  ...
  public AuditEvent time(@jakarta.annotation.Nullable OffsetDateTime time) {
    this.time = time;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.email, auditEvent.email) &&
        Objects.equals(this.eventType, auditEvent.eventType) &&
        Objects.equals(this.detail, auditEvent.detail) &&
        Objects.equals(this.ip, auditEvent.ip) &&
        Objects.equals(this.time, auditEvent.time);
  }

  @Override
  public int hashCode() {
    return Objects.hash(email, eventType, detail, ip, time);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("email", "event_type", "detail", "ip", "time"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AuditEvent.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in AuditEvent is not found in the empty JSON string", AuditEvent.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AuditEvent.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `AuditEvent` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

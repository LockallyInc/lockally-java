...
public class Admin {
  ...
  public Admin id(@jakarta.annotation.Nonnull UUID id) {
    this.id = id;
    return this;
  }
  ...
  public Admin tenantId(@jakarta.annotation.Nonnull UUID tenantId) {
  ...
  public Admin email(@jakarta.annotation.Nonnull String email) {
    this.email = email;
    return this;
  }
  ...
  public Admin displayName(@jakarta.annotation.Nullable String displayName) {
  ...
  public Admin role(@jakarta.annotation.Nonnull RoleEnum role) {
    this.role = role;
    return this;
  }
  ...
  public Admin lastLoginAt(@jakarta.annotation.Nullable OffsetDateTime lastLoginAt) {
  ...
  public Admin createdAt(@jakarta.annotation.Nonnull OffsetDateTime createdAt) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, admin.id) &&
        Objects.equals(this.tenantId, admin.tenantId) &&
        Objects.equals(this.email, admin.email) &&
        Objects.equals(this.displayName, admin.displayName) &&
        Objects.equals(this.role, admin.role) &&
        Objects.equals(this.lastLoginAt, admin.lastLoginAt) &&
        Objects.equals(this.createdAt, admin.createdAt);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, tenantId, email, displayName, role, lastLoginAt, createdAt);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("id", "tenant_id", "email", "display_name", "role", "last_login_at", "created_at"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("id", "tenant_id", "email", "role", "created_at"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Admin.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in Admin is not found in the empty JSON string", Admin.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Admin.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `Admin` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Admin.openapiRequiredFields) {

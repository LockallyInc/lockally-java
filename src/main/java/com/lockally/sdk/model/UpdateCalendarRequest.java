...
public class UpdateCalendarRequest {
  ...
  public UpdateCalendarRequest name(@jakarta.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public UpdateCalendarRequest color(@jakarta.annotation.Nullable String color) {
    this.color = color;
    return this;
  }
  ...
  public UpdateCalendarRequest ownerEmail(@jakarta.annotation.Nullable String ownerEmail) {
  ...
  public UpdateCalendarRequest description(@jakarta.annotation.Nullable String description) {
  ...
  public UpdateCalendarRequest visibility(@jakarta.annotation.Nullable VisibilityEnum visibility) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, updateCalendarRequest.name) &&
        Objects.equals(this.color, updateCalendarRequest.color) &&
        Objects.equals(this.ownerEmail, updateCalendarRequest.ownerEmail) &&
        Objects.equals(this.description, updateCalendarRequest.description) &&
        Objects.equals(this.visibility, updateCalendarRequest.visibility);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, color, ownerEmail, description, visibility);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("name", "color", "owner_email", "description", "visibility"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateCalendarRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in UpdateCalendarRequest is not found in the empty JSON string", UpdateCalendarRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateCalendarRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `UpdateCalendarRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

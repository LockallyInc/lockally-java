...
public class UserEvent {
  ...
  public static final String SERIALIZED_NAME_DAYS_INACTIVE = "days_inactive";
  @SerializedName(SERIALIZED_NAME_DAYS_INACTIVE)
  @jakarta.annotation.Nullable
  ...
  public UserEvent email(@jakarta.annotation.Nullable String email) {
    this.email = email;
    return this;
  }
  ...
  public UserEvent eventAt(@jakarta.annotation.Nullable OffsetDateTime eventAt) {
  ...
  public void setEventAt(@jakarta.annotation.Nullable OffsetDateTime eventAt) {
    this.eventAt = eventAt;
  }


  public UserEvent daysInactive(@jakarta.annotation.Nullable Integer daysInactive) {
  ...
  public void setDaysInactive(@jakarta.annotation.Nullable Integer daysInactive) {
    this.daysInactive = daysInactive;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.email, userEvent.email) &&
        Objects.equals(this.eventAt, userEvent.eventAt) &&
        Objects.equals(this.daysInactive, userEvent.daysInactive);
  }

  @Override
  public int hashCode() {
    return Objects.hash(email, eventAt, daysInactive);
  }
  ...
  public String toString() {
    ...
    sb.append("    daysInactive: ").append(toIndentedString(daysInactive)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("email", "event_at", "days_inactive"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UserEvent.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in UserEvent is not found in the empty JSON string", UserEvent.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UserEvent.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `UserEvent` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
